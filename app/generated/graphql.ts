...
export type GetCollectionsForMenuQuery = {
  __typename?: 'Query';
  collections: {
    __typename?: 'CollectionList';
    items: Array<{
...
export function getSdk<C, E>(requester: Requester<C, E>) {
  return {
    ...
    getCollectionsForMenu(
      variables?: GetCollectionsForMenuQueryVariables,
      options?: C,
    ): Promise<GetCollectionsForMenuQuery> {
      return requester<
        GetCollectionsForMenuQuery,
        GetCollectionsForMenuQueryVariables
      >(
        GetCollectionsForMenuDocument,
        variables,
        options,
      ) as Promise<GetCollectionsForMenuQuery>;
    },
    activeCustomer(
    ...
    searchProduct(
      ...
      options?: C,
    ): Promise<SearchProductQuery> {
      return requester<SearchProductQuery, SearchProductQueryVariables>(
        SearchProductDocument,
        variables,
        options,
      ) as Promise<SearchProductQuery>;
    },
  };
}
