...
export type ListedProductFragment = { __typename?: 'SearchResult', productId: string, productName: string, slug: string, currencyCode: CurrencyCode, facetValueIds: Array<string>, productAsset?: { __typename?: 'SearchResultAsset', id: string, preview: string } | null, price: { __typename: 'PriceRange', min: number, max: number } | { __typename: 'SinglePrice', value: number }, priceWithTax: { __typename: 'PriceRange', min: number, max: number } | { __typename: 'SinglePrice', value: number } };
